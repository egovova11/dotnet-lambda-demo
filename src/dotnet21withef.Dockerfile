...
ENTRYPOINT dotnet test ./DotnetLambda21WithEf.Tests/DotnetLambda21WithEf.Tests.csproj --configuration Release --no-restore --no-build --logger "trx;LogFileName=/out/dotnet21.trx"
